...
**Locations to update:**
- The orchestrator prompt template in `workflow-orchestration-queue-hotel41-a` (e.g., `scripts/prompt.ps1`, `orchestrator-supervisor.md`, or the assembled prompt).
...
| Orchestrator prompt (TBD exact file) | workflow-orchestration-queue-hotel41-a | Define 4-step loop |
